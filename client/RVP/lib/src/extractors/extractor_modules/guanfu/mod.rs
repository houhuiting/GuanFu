...
impl Extractor for GuanFuExtractor {
    ...
    fn verify_and_extract(&self, provenance: &str) -> Result<ReferenceValue> {
        ...
        let rv = ReferenceValue::new()
            ...
            .add_hash_value(
                "sha256".to_string(),
                unserialized.binary.checksum.sha256.to_string(),
            );
        Ok(rv)
    }
}
...
pub mod test {
    ...
    use super::{Binary, Checksum, Config, Dependency, Environment, Provenance, Source};
    ...
    pub fn generate_guanfu_provenance() -> String {
        ...
        let com = vec![
            "rustup target add x86_64-unknown-linux-musl".to_string(),
        ...
        let con = Config {
            version_gf: "0.1".to_string(),
        };
        let dep1 = Dependency {
            source_dep: "make".to_string(),
            version_dep: "4.1-9.1ubuntu1".to_string(),
        };
        let dep2 = Dependency {
            source_dep: "rust".to_string(),
            version_dep: "1.63.0".to_string(),
        };
        let dep3 = Dependency {
        ...
        let dep4 = Dependency {
            ...
            version_dep: "7.58.0-2ubuntu3.19".to_string(),
        };
        let dep5 = Dependency {
            source_dep: "libseccomp-dev".to_string(),
            version_dep: "2.5.1-1ubuntu1~18.04.2".to_string(),
        };
        let dep6 = Dependency {
            source_dep: "gcc".to_string(),
            version_dep: "4:7.4.0-1ubuntu2.3".to_string(),
        };
        ...
        let sou = Source {
            source_link: "https://github.com/kata-containers/kata-containers.git".to_string(),
    ...
    fn guanfu_extractor() {
        ...
        let rv = ReferenceValue::new()
            ...
            .add_hash_value(
                "sha256".to_string(),
                "9ca442bb48a1b6ed4409a18e95e519e48b1da7da34a9319271d959cabdb06706".to_string(),
            );
